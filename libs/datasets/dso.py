...
class Singapore(Dataset):
    """Base class of dataset loaders for Singapore Driving Sequence
    """

    def __init__(self, *args, **kwargs):
        self.time_offset = 0
        super(Singapore, self).__init__(*args, **kwargs)

        # undistortion model
        # camera_model_dir = os.path.join(self.cfg.directory.img_seq_dir, 'robotcar-dataset-sdk', 'models')
        camera_model_dir ="/home/marcelbp/Desktop/Oxford-dataset/data_for_VO_rain_eval/robotcar-dataset-sdk/models"
        img_dir = os.path.join(self.cfg.directory.img_seq_dir, self.cfg.seq, 'left_undistort')
        # self.model = CameraModel(camera_model_dir, img_dir) # seems for evaluation, throws error perhaps
    ...
    def get_intrinsics_param(self):
        ...
        #                     )
        intrinsic_txt = "/home/marcelbp/Desktop/Oxford-dataset/data_for_VO_rain_eval/robotcar-dataset-sdk/models/dso_left_singapore_wide_left.txt"
        ...
        # crop
        self.x_crop = [0.0, 1.0]
        self.y_crop = [0.0, 0.752941177] # this 0.752941177 is to crop 340 to 256, resulting in 256.000000... , floored by using int() to become 256 exact
